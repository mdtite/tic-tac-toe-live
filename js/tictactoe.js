...
//This function parses the selectedsquares array to determine if a player has won //The drawLine function is called if a win condition is met
...
function animateLineDrawing() {
    ...
    c.lineTo(x, y);
    c.lineWidth = 10;
    c.strokeStyle = 'rgba(81, 239, 181, 0.8)';
    c.stroke();
    if (x1 <= x2 && y1 <= y2) {
        if (x < x2) { x += 10; }
        if (y < y2) { y += 10; }
